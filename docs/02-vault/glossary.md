...
| Version (Phiên bản)                                | Một bản cụ thể của tài liệu được tạo khi nội dung được cập nhật; hệ thống phải nhận biết version hiện hành và version đã bị thay thế.                                                          |
| Version hiện hành                                  | Version chính thức đang được dùng cho tìm kiếm và Q&A tại một thời điểm; mỗi tài liệu chỉ có một version hiện hành.                                                                            |
...
| Citation (Nguồn trích dẫn)                         | Thông tin định danh tài liệu hoặc version được AI sử dụng để tạo câu trả lời, giúp người dùng kiểm tra lại nguồn. Câu hỏi nào bắt buộc citation là `UNKNOWN/TBD`.                              |
...
- `Version` là bản tài liệu; `Version hiện hành` là bản chính thức đang được dùng, nên hai thuật ngữ này không đồng nghĩa.
...
2. Version tăng ở mỗi lần sửa, gửi Review hay Publish; có cho phép khôi phục version cũ không?
3. Những câu hỏi nào bắt buộc phải có Citation và tiêu chí nào xác định câu hỏi “cần kiểm chứng”?
4. Danh sách đầy đủ hoạt động phải ghi vào Audit log và thời gian lưu log là bao lâu?
